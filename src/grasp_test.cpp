...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        for (int i = 0; i < 41; i++){
            target_pose_1.ref_pose[i].position.x = object_pose.pose.position.x;
            target_pose_1.ref_pose[i].position.y = object_pose.pose.position.y-0.25;
        ...
        for (int i = 0; i < 41; i++){
            ...
            target_pose_2.ref_pose[i].position.y = object_pose.pose.position.y-0.25;
        ...
        for (int i = 0; i < 41; i++){
                ...
                target_pose_3.ref_pose[i].position.y = object_pose.pose.position.y-0.25;
                target_pose_3.ref_pose[i].position.z = 0.2;
