...
geometry_msgs::PoseStamped object_pose, current_object_pose;
...
int main(int argc, char **argv)
{
    ...
    while(ros::ok()){
        ...
        std::cout<<"x: "<< current_object_pose.pose.position.x<<std::endl;
        std::cout<<"y: "<< current_object_pose.pose.position.y<<std::endl;
